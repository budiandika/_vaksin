...
<div class="panel panel-full">
	<div class="panel-heading ">
		<h4>Pengaturan <span id="x-title">Satuan</span></h4>
		<br/>
		<small>Pengaturan \ Satuan</small>
...
@section('scripts')
    ...
    <script type="text/javascript">
    	...
    	$('.s_parkir').parent().parent().addClass("active");
                ...
                var $data = getData("{{url('api/settings/satuan')}}/","satuan_id");
                $("#x-data").dxDataGrid({
                    dataSource: $data,
                    columns: [
                            {dataField: "satuan_nama", caption: "Nama Satuan",validationRules: [{ type: "required" }]},
                    ],
